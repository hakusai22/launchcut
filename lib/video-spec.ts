...
export const defaultVideoSpec: VideoSpec = {
  brand: {
    name: "Renkumi",
    tagline: "组合镜头与动态，快速合成为产品展示视频",
    logoSrc: "/assets/renkumi-icon.png",
    primaryColor: "#171717",
  ...
  assets: [
    {
      id: "hero",
      type: "background",
      src: "/assets/renkumi-hero.svg",
      alt: "Renkumi campaign workspace",
    },
    {
      id: "workflow",
      type: "screenshot",
      src: "/assets/renkumi-workflow.svg",
      alt: "Renkumi workflow screenshot",
    },
    {
      id: "results",
      type: "screenshot",
      src: "/assets/renkumi-results.svg",
      alt: "Renkumi results dashboard",
    },
  ],
  scenes: [
    {
    ...
    },
    {
      ...
      narration: "Renkumi 把宣传片拆成可配置的数据，而不是一次性的剪辑文件。",
    ...
    },
    {
      ...
      narration: "Renkumi 的价值不是做一条视频，而是建立长期可复用的推广生产线。",
      durationInSeconds: 15,
      assetId: "results",
    ...
    },
    {
      ...
      narration: "用 Renkumi，把推广内容变成工程化能力。",
      durationInSeconds: 5,
      assetId: "results",
      layout: "cta",
      visualTreatment: "spotlight",
